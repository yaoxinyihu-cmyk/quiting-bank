...
Page({
  data:{
    ...
    msgsPreview:[
      ...
      {id:2, name:'星河', avatar:'/assets/avatars/a2.png', time:'12:05', text:'想烟时多喝水/深呼吸~'},
      {id:3, name:'唐宁', avatar:'/assets/avatars/a3.png', time:'18:33', text:'每一天的小胜利，汇聚成大改变！'}
    ]
  },
  ...
  openAllMsgs(){ wx.showToast({ title:'留言板弹层稍后接入', icon:'none' }); },
